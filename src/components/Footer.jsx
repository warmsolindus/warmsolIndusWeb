...
const SITEMAP = [
  {
    ...
    links: [
      ...
      { title: "Procurement Services", path: "/procurement-services" },
    ],
  },
  {
    title: "Help Center",
...

  {
    title: "Products",
    links: [
      { title: "Insulation Materials", path: "/insulation-materials" },
      {
        title: "Metal Jacketing Materials",
        path: "/metal-jacketing-materials",
      },
      {
        title: "Insulation & Cladding Accessories",
