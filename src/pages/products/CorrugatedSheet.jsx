          ...
          <div class="md:flex">
            <div class="md:shrink-0">
              <img
                ...
                src="./src/images/corrugatedSheet.png"
      ...
      <div className="mx-4 md:mx-20 my-10 px-6 bg-white rounded-lg">
        <>
          <Accordion open={openAcc1}>
            ...
            Corrugated sheets are manufactured for enhanced strength, rigidity, and durability, making them suitable for a wide range of industrial and architectural applications. Available in Aluminium and Stainless Steel, these sheets provide excellent weather resistance, corrosion protection, and aesthetic appeal.
<p> &nbsp;</p>
<p>&#10148; Available thickness range: 0.3mm to 1mm.</p>
<p>&#10148; Available Finishes: a smooth finish, a stucco embossed pattern, and 3/16" cross crimped</p>
&#10148; Corrugation Profile: 11/4"(depth of 1/4") and 21/2"(depth of 5/8") corrugations

            </AccordionBody>
          </Accordion>
          <Accordion open={openAcc2}>
            <AccordionHeader onClick={handleOpenAcc2}>Aluminium Corrugated Sheet</AccordionHeader>
            <AccordionBody className="max-w-[700px]">
            ...
            <ul>
                ...
                <li>&#10004; &nbsp; High corrosion resistance, even in marine environments</li>
              ...
              <ul>
                ...
                <li> &nbsp; </li>
                <li>&#10004; &nbsp; Insulated piping, tanks, and vessels (with or without a moisture barrier)</li>
          ...
          <Accordion open={openAcc3}>
            ...
            <ul>
                ...
                <li>&#10004; &nbsp; Excellent corrosion resistance, especially in harsh chemical or marine environments</li>
                <li>&#10004; &nbsp; Aesthetic appeal for architectural projects</li>
              ...
              <ul>
                ...
                <li className="font-extrabold"> &nbsp; Applications:</li>
                <li> &nbsp; </li>
                <li>&#10004; &nbsp; Industrial cladding for equipment and structures</li>
                <li>&#10004; &nbsp; Chemical plants and marine facilities</li>
                <li>&#10004; &nbsp; Industries like Petrochemical, Oil and Gas</li>
                <li>&#10004; &nbsp; Insulation jacketing for extreme environments</li>
              </ul>
            </AccordionBody>
          </Accordion>
        </>
