        ...
        <div class="max-w-md mx-auto my-8 bg-white rounded-xl shadow-md overflow-hidden md:max-w-2xl">
          <div class="md:flex">
            ...
            <div class="p-8">
              ...
              Aluminum sheets are manufactured from high-quality alloys, offering superior corrosion resistance, durability, and strength. These sheets are available with or without a moisture barrier, tailored for various applications in insulation and industrial environments.
              </p>
...
durability, and strength. These sheets are available with or without a
moisture barrier, tailored for various applications in insulation and industrial environments.
<h5>Available thickness range: 0.3mm to 1mm.</h5>
Available finishes: Smooth, Stucco Embossed, Corrugated (cross-crimped).
            </AccordionBody>
          </Accordion>
          <Accordion open={openAcc2}>
            <AccordionHeader onClick={handleOpenAcc2}>Aluminium Sheet With Moisture Barrier</AccordionHeader>
            <AccordionBody>
            A thin layer of poly-surlyn is coated to the interior surface of the sheet to prevents moisture, enhance durability and protects insulation systems from corrosion.
              <ul>
                <li> &nbsp;</li>
          ...
          <Accordion open={openAcc3}>
            ...
            <AccordionBody>
            Suitable for applications where moisture protection is unnecessary or an external protective coating is provided.
              <ul>
                <li> &nbsp;</li>
                <li className="font-extrabold"> &nbsp; Applications:</li>
                <li> &nbsp; </li>
                <li>&#10004; &nbsp; Insulation jacketing in low-humidity environments</li>
