  ...
  return (
    <div className="min-h-screen bg-amber-50">
          ...
          <CardBody className="p-0">
            <div className="flex flex-col lg:flex-row">
              ...
              <div className="lg:w-1/2 p-6 sm:p-8">
                <Typography variant="h2" color="blue-gray" className="mb-2 sm:mb-4 text-2xl sm:text-3xl lg:text-4xl">
                Ceramic Fiber Blanket
                </Typography>
                <Typography variant="lead" className="mb-2 sm:mb-4 text-sm sm:text-base">
                ...
                <Typography variant="paragraph" className="mb-2 sm:mb-4 text-xs sm:text-sm">
                  Product code: CFB
                </Typography>
                <Typography variant="h6" color="blue" className="mb-2 text-sm sm:text-base">
                  Key Features:
                </Typography>
        ...
        <Card>
          ...
          >
            <Typography variant="h4" color="white" className="text-lg sm:text-xl lg:text-2xl pl-4">
              Product Details
            </Typography>
          </CardHeader>
          <CardBody>
            <Tabs value={activeTab}>
              <TabsHeader className="overflow-x-auto bg-amber-900">
                {["Description", "Specifications", "Benefits", "Applications"].map((tab) => (
                  <Tab 
                    key={tab.toLowerCase()} 
              ...
              in the industry.
                ...
                <TabPanel value="specifications">
                  ...
                  <List className="space-y-1">
                    {["Specification 1: Value", "Specification 2: Value", "Specification 3: Value", "Specification 4: Value", "Specification 5: Value"].map((spec, index) => (
                      <ListItem key={index} className="text-sm sm:text-base">{spec}</ListItem>
                    ))}
                  </List>
                </TabPanel>
                <TabPanel value="benefits">
                  ...
                  <List className="space-y-2">
                    {["Benefit 1: Description of the benefit", "Benefit 2: Description of the benefit", "Benefit 3: Description of the benefit"].map((benefit, index) => (
                ...
                <TabPanel value="applications">
                  ...
                  <List className="space-y-1">
                    {["Application 1: Description", "Application 2: Description", "Application 3: Description", "Application 4: Description"].map((application, index) => (
                      <ListItem key={index} className="text-sm sm:text-base">{application}</ListItem>
                    ))}
                  </List>
                </TabPanel>
              </TabsBody>
