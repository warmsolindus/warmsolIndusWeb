const tapesFoils = [
  {
    imgUrl: "/images/tfo1.jpg",
    title: "Fiber Glass Tape",
    subTitle:
      " Fiberglass tape is made up of twisted fiberglass threads. These strands are braided at right angles to form a specific width of fiberglass cloth. In order to prevent the cloth from spreading, it contains the edge of the cloth edge",
    links: "/tapes-foils/fiber-glass-tape",
  },

  {
    imgUrl: "/images/tfo2.jpg",
    title: "Filament Tape",
    subTitle:
    ...
    links: "/tapes-foils/filament-tape",
  },
  {
    imgUrl: "/images/tfo3.jpg",
    title: " Re-Inforced Aluminum Foil Tape",
    subTitle:
      "Aluminum foil tape is suitable for smooth flat and irregular surfaces. It is generally used for sealing hot and cold air ducts (excellent HVAC duct tape), pipe insulation systems, sealing aluminum, stainless steel and plastic",
    links: "/tapes-foils/re-inforced-aluminium",
  },
  {
